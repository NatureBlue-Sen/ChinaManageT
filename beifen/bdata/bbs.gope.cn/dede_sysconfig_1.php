...
E_D("replace into `dede_sysconfig` values('1','cfg_basehost','站点根网址','1','string','http://127.0.0.1');");
E_D("replace into `dede_sysconfig` values('2','cfg_cmspath','DedeCMS安装目录','2','string','');");
E_D("replace into `dede_sysconfig` values('3','cfg_cookie_encode','cookie加密码','2','string','MdXCt1137Z');");
...
E_D("replace into `dede_sysconfig` values('7','cfg_webname','网站名称','1','string','我的网站');");
...
E_D("replace into `dede_sysconfig` values('21','cfg_feedbackcheck','评论及留言(是/否)需审核','5','bool','Y');");
...
E_D("replace into `dede_sysconfig` values('28','cfg_powerby','网站版权信息','1','bstring','Copyright &copy; 2002-2011 DEDECMS. 织梦科技 版权所有');");
...
E_D("replace into `dede_sysconfig` values('712','cfg_beian','网站备案号','1','string','备案中...');");
