...
E_D("replace into `dede_co_onepage` values('5','www.dedecms.com','÷Ø√ŒÕ¯¬Á','1','gb2312','<div class=\"content\">{@body}<div class=\"cupage\">');");
E_D("replace into `dede_co_onepage` values('4','www.techweb.com.cn','Techweb','1','gb2312','<div class=\"content_txt\">{@body}</div>	\n');");
E_D("replace into `dede_co_onepage` values('6','tw.news.yahoo.com','Ã®ÕÂ—≈ª¢','1','big5','<div id=\"ynwsartcontent\">{@body}</div>	\n');");
